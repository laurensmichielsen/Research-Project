...
def create_annotation(centers, epsilon=0.0005):
    ...
    bbox_width = random.uniform(0, width_range)
    bbox_height = random.uniform(0, height_range)
...
# labels_folder = "./../../results/exp2/exp2_run_2_4/Research/data/PASCAL/labels/train"
# target_labels_folder = "./../../results/exp2/exp2_run_2_4/Research/data/PASCAL/noise2"

# seeds = [14, 15, 16, 17, 18]
# for seed in seeds:
#     generate_noise_type2(labels_folder, target_labels_folder, seed)
